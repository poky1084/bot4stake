				...
				if(obj.payload.data.hasOwnProperty("crash") && game == "crash" ){
					...
					if(obj.payload.data.crash.event.result == "autocashout")
					{
						...
						if(profit_total < 0){
								...
								if(document.getElementById("themebot").value == "dark" || document.getElementById("themebot").value == "blue"){
