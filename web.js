...
function data(json){
	if(running == true)
	{
		...
		if(json.data.hasOwnProperty("plinkoBet"))
		{
			...
			tdhigh.appendChild(tdcheck);
			tdTargetChance.innerHTML = json.data.plinkoBet.state.risk + "|" + json.data.plinkoBet.state.rows
			...
			tdRollChance.innerHTML = multiplierOut.toFixed(2) + "x"
		...
		if(json.data.hasOwnProperty("kenoBet"))
		{
			...
			tdhigh.appendChild(tdcheck);
			tdTargetChance.innerHTML = json.data.kenoBet.state.risk
			...
			tdRollChance.innerHTML = multiplierOut.toFixed(2) + "x (" + hitkeno.length + "x) "
			
			tdProfit.innerHTML = current_profit.toFixed(8)

			tdTargetNumber.innerHTML = JSON.stringify(json.data.kenoBet.state.selectedNumbers)

			tdRollNumber.innerHTML = JSON.stringify(json.data.kenoBet.state.drawnNumbers)
		...
		if(json.data.hasOwnProperty("minesBet"))
		{
			...
			tdhigh.appendChild(tdcheck);
			tdTargetChance.innerHTML = json.data.minesBet.state.minesCount

			tdRollChance.innerHTML = multiplierOut.toFixed(2) + "x (" + hitmines + ")"
			
			tdProfit.innerHTML = current_profit.toFixed(8)

			tdTargetNumber.innerHTML = JSON.stringify(json.data.minesBet.state.mines)

			tdRollNumber.innerHTML = JSON.stringify(str_field)
