...
function data(json){
	if(running == true)
	{
		...
		if(json.data.hasOwnProperty("kenoBet"))
		{
			...
			if(json.data.kenoBet.payoutMultiplier > 0){
				win = true;
				lastBet.win = true;
				color = "#05f711"
				//win
